...
public class CaricaVotiController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		for(int i=4; i<=sheet.getLastRowNum(); i++){
			...
			double fantavoto = votazione + (goalFatto * 3) - (goalSubito) + assist_totali - ammonito - (espulso * 3) - (autorete * 3)
					+ (goalSuRigore * 2) + (rigoreParato * 3) - (rigoreSbagliato * 3) + goalVittoria + goalPareggio;
